        ...
        <div class="g-position--relative g-bg-color--primary">
            <div class="g-container--md g-padding-y-125--xs">
                <div class="g-text-center--xs g-margin-t-50--xs g-margin-b-80--xs">
                    ...
                    <h2 class="g-font-size-32--xs g-font-size-36--sm g-color--white">お問合わせ｜資料請求</h2>
                </div>
                <div class="row g-row-col--5 g-margin-b-80--xs">
                    <div class="col-xs-4 g-full-width--xs g-margin-b-50--xs g-margin-b-0--sm">
                        <div class="g-text-center--xs">
                            ...
                            <p class="g-color--white">mail@yamazaki-stove.jp</p>
                        </div>
                    </div>
                    <div class="col-xs-4 g-full-width--xs g-margin-b-50--xs g-margin-b-0--sm">
                        <div class="g-text-center--xs">
                            ...
                            <p class="g-color--white">〒020-0816<br>盛岡市中野1-4-26</p>
                        </div>
                    </div>
                    <div class="col-xs-4 g-full-width--xs">
                        <div class="g-text-center--xs">
                            <i class="g-display-block--xs g-font-size-40--xs g-color--white-opacity g-margin-b-30--xs fa fa-phone"></i>
                            <h4 class="g-font-size-18--xs g-color--white g-margin-b-5--xs">Phone</h4>
                            ...
                            <div class="cbp-item buying">
                                <div class="cbp-caption g-text-center--xs">
                                    ...
                                    <div class="cbp-caption-activeWrap">
                                        <div class="g-color--orange g-font-size-12--sm g-font-size-16--md g-padding-x-25--xs g-padding-y-25--xs g-bg-color--white g-text-left--xs">
                                            <h4>個人情報の取り扱いにつきまして</h4>
...
<br>
            ...
            <img class="s-mockup-v2" src="<?php bloginfo('template_url'); ?>/img/mockups/pencil-01.png" alt="Mockup Image">
        </div>
        <!-- End Feedback Form -->
        <!--========== END PAGE CONTENT ==========-->
