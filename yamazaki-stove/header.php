...
<html lang="ja" class="no-js">
    <head>   
        ...
        <link href=" <?php bloginfo('template_url'); ?>/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
        <link href=" <?php bloginfo('template_url'); ?>/css/animate.css" rel="stylesheet" type="text/css"/>
        <link href=" <?php bloginfo('template_url'); ?>/vendor/themify/themify.css" rel="stylesheet" type="text/css"/>
        <link href=" <?php bloginfo('template_url'); ?>/vendor/scrollbar/scrollbar.min.css" rel="stylesheet" type="text/css"/>
        <link href=" <?php bloginfo('template_url'); ?>/vendor/magnific-popup/magnific-popup.css" rel="stylesheet" type="text/css"/>
        <link href=" <?php bloginfo('template_url'); ?>/vendor/swiper/swiper.min.css" rel="stylesheet" type="text/css"/>
        <link href=" <?php bloginfo('template_url'); ?>/vendor/cubeportfolio/css/cubeportfolio.min.css" rel="stylesheet" type="text/css"/>
        <link href=" <?php bloginfo('template_url'); ?>/css/style.css" rel="stylesheet" type="text/css"/>
        <link href=" <?php bloginfo('template_url'); ?>/css/global/global.css" rel="stylesheet" type="text/css"/>
                        ...
                        <div class="s-header__navbar-row-col">
                            ...
                            <div class="s-header__logo">
                                <a href="/" class="s-header__logo-link">
                                    <img class="s-header__logo-img s-header__logo-img-default" src="<?php bloginfo('template_url'); ?>/img/logo.png" alt="yamazaki Logo" width="240px" height="auto">
                                    <img class="s-header__logo-img s-header__logo-img-shrink" src="<?php bloginfo('template_url'); ?>/img/logo-dark.svg" alt="yamazaki Logo" width="240px">
                                </a>
                            </div>
                ...
                <nav class="s-header__nav js__scrollbar">
                    <div class="container-fluid">
                        ...
                        <ul class="list-unstyled s-header__nav-menu">
                            ...
                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href="/stoves/">取扱ストーブ</a></li>
                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href="/gallery/">施工例</a></li>
                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href="/other/">ハイブリッド</a></li>
                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href="/faq/">よくある質問</a></li>
                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href="/contact/">お問い合わせ</a></li>
                        </ul>
                        <!-- End Menu List -->

                                           
                        <ul class="list-unstyled s-header__nav-menu">
                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href="/category/blog/">ブログ</a></li>
                            <!-- End Menu List--<li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href="team.html">Team</a></li>
